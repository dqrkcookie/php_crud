...
if(isset($_POST['add_product'])){
    ...
    $query = "INSERT INTO product_tbl(productName, productPrice, productDetails, productPicture, productStocks, category, showProduct, totalStocks)VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
